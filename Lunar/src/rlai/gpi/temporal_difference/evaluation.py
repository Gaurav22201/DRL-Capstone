...
from rlai.utils import IncrementalSampleAverager, sample_list_item, RunThreadManager
...
def evaluate_q_pi(
    ...
    :param thread_manager: Thread manager for the thread that is executing the current function.
